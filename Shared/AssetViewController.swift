...
class AssetViewController: UIViewController {
    ...
    @IBAction func editAsset(_ sender: UIBarButtonItem) {
        ...
        if asset.canPerform(.content) {
            ...
            alertController.addAction(UIAlertAction(title: NSLocalizedString("Grey Image", comment: ""),style: .default, handler: getFilter("CIPhotoEffectNoir")))
            //Add action to crop images.....
            //alertController.addAction(UIAlertAction(title: NSLocalizedString("Crop Image", comment: ""),
            //                                                   style: .default, handler: cropImage()))

            // Add actions to revert any edits that have been made to the PHAsset.
            alertController.addAction(UIAlertAction(title: NSLocalizedString("Revert", comment: ""),style: .default, handler: revertAsset))
        }
    ...
    @IBAction func toggleFavorite(_ sender: UIBarButtonItem) {
        PHPhotoLibrary.shared().performChanges({
            ...
            if success {
                DispatchQueue.main.sync {
                    sender.title = self.asset.isFavorite ? "😍" : "♡"
                }
            } else {
