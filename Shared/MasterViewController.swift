...
class MasterViewController: UITableViewController,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    //======================================================
    // Click button to activate camera, photo library and cancel action....
    @IBAction func importPhotos(_ sender: UIButton) {
        let imagePickerController = UIImagePickerController()
        
        imagePickerController.delegate = self
        
        let actionSheet = UIAlertController(title: "Photo scource",message: "Choose a source",preferredStyle: .actionSheet)
        //MARK: start camera....
        ...
        // MARK: cancel button and stay still......
        actionSheet.addAction(UIAlertAction(title: "Cancel", style: .default, handler: nil))
        self.present(actionSheet,animated: true,completion: nil)
    }
    //Save new photos...
    @IBAction func savePhotos(_ sender: UIButton) {
  ...
  //======================================================
    // button format for add...
    //        let addButton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(self.addAlbum))
    //        self.navigationItem.rightBarButtonItem = addButton
    
    //        //button format for camera....
    //        let cameraButton = UIBarButtonItem(barButtonSystemItem: .camera, target: self, action: #selector(self.openCamera))
...
//
//        let alertController = UIAlertController(title: NSLocalizedString("Camera", comment: ""), message: nil, preferredStyle: .alert)
////        alertController.addTextField { textField in
////            textField.placeholder = NSLocalizedString("Album Name", comment: "")
////        }
//
//        alertController.addAction(UIAlertAction(title: NSLocalizedString("New Photo", comment: ""), style: .default) { action in
//            //
//            let textField = alertController.textFields!.first!
//            if let title = textField.text, !title.isEmpty {
//                // Create a new album with the title entered.
